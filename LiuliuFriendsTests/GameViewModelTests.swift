...
final class GameViewModelTests: XCTestCase {
    ...
    func testContentCoversCoreFriendCategories() {
        ...
        XCTAssertEqual(categories, [.animal, .vehicle, .fruit, .shape, .body, .clothing, .vegetable, .object])
    }
    ...
    func testGameModesHaveStableSettingsGroups() {
        ...
        XCTAssertEqual(Set(groupedModes["基础识物", default: []]), [.animal, .sound, .color, .shape, .body, .clothing, .vegetable])
    ...
    func testRecognizedSoundPromptCatalogDoesNotOverrideShapesOrFruit() {
        for kind in FriendKind.allCases where kind.category == .shape || kind.category == .fruit || kind.category == .vegetable {
