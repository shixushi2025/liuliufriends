...
本应用为儿童启蒙配对游戏，App 名称为「肚兜启蒙」，当前小游戏为「六六找朋友」。无账号登录、无广告、无内购、无网络请求。主要功能包括动物识别、声音配对、颜色识别、形状认知、大小比较、影子匹配、数量认知、位置认知、用途认知、场景认知和分类认知。进入游戏后需要点击「开始玩」才会播放第一条语音提示。家长设置页可关闭音效、语音提示、自动下一题、休息提醒、护眼模式、减少动画和具体玩法类别。
...
| 主要功能 | 动物、声音、颜色、形状、大小、影子、数量、位置、用途、场景和分类配对认知 |
| 用户体系 | 无账号注册、无登录 |
| 数据收集 | 不收集用户数据，不追踪 |
